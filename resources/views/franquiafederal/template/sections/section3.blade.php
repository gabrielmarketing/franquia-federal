<section class=" section-work-app" data-scroll-index="2" style="background-image: url('{{ asset("public/assets/images/dummy-image-small.jpg") }}');    background-attachment: fixed;
            ...
            <div class="row align-items-center">
                <div class="col-md-4 app-work-sider-div">
                    <div class="app-slider-wrapper">
                        ...
                        <ul class="slider">
                            <li class="slide-item">
                                <img src="{{ asset("assets/images/dummy-image-slider.png") }}" alt="Awesome Image"/>
                            </li>
                            <li class="slide-item">
                                <img src="{{ asset("assets/images/dummy-image-slider.png") }}" alt="Awesome Image"/>
                            </li>
