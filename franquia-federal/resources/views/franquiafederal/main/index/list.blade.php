<body>
<!--Home Section Start-->
<section id="home" class="banner banner-default banner-wave" style="background-image: url('{{ asset("public/assets/images/background/dummy-image.jpg") }}')" data-stellar-background-ratio=".7" data-scroll-index="0">
    <div class="overlay">
        <div class="container h-100">
            <div class="row h-100">
                <div class="col-lg-7 d-flex align-items-center">
                    <div class="header-app ">
                        <h2>Make your App Page with TasApp</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            consequat.</p>
                        <div class="header-button">
                            <a href="#" class="taso-btn header">Read More</a>
                            <a href="#" class="taso-btn header header-transparent">Features</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="header-slides owl-carousel mt-150 text-center">
                        ...
                        <img class="img-fluid" src="{{ asset("public/assets/images/scrn/dummy-image.png") }}" alt="">
                        </div>
                        <div class="single-mobile">
                            <img class="img-fluid" src="{{ asset("public/assets/images/scrn/dummy-image.png") }}" alt="">
                        </div>
...
<section class=" section-work-app" data-scroll-index="2" style="background-image: url('assets/images/dummy-image-small.jpg');    background-attachment: fixed;
            ...
            <div class="row align-items-center">
                <div class="col-md-4 app-work-sider-div">
                    <div class="app-slider-wrapper">
                        ...
                        <ul class="slider">
                            <li class="slide-item">
                                <img src="{{ asset("public/assets/images/dummy-image-slider.png") }}" alt="Awesome Image"/>
                            </li>
                            <li class="slide-item">
                                <img src="{{ asset("public/assets/images/dummy-image-slider.png") }}" alt="Awesome Image"/>
                            </li>
...
<section class="pt-100 pb-100">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="show-case-img img-left">
                    <img src="{{ asset("public/assets/images/dummy-image-side.png") }}" alt="">
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="" style="background-image: url('{{ asset("public/assets/images/dummy-image-small.jpg") }}');    background-attachment: fixed;
            background-size: cover;
            background-repeat: no-repeat;">
    <div class="overlay-7 pt-100 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="video-title">Watch a Video Tutorial</h2>
                    <div class="background-btn">
                        <a href="https://www.youtube.com/watch?v=7e90gBu4pas" class="paly-video-btn popup-video"><i class="fas fa-play"></i></a>
                    </div>
...
<section class="pt-100 pb-100" data-scroll-index="4">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="section-title">
                    <div class="main-title">
                        <div class="title-main-page">
                            <h4>Clients Says</h4>
                            <p>Best Comments of Our Clients</p>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div id="testimonial-slider" class="owl-carousel">
                    ...
                    <div class="testimonial">
                        <div class="pic">
                            <img src="{{ asset("public/assets/images/user/dummy-image.jpg") }}" alt="">
                        </div>
                        <div class="testimonial-content">
                            <h3 class="testimonial-title">Jone Doe
                                <small class="post">Web Designer</small>
                            </h3>
                            <p class="description">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. A aliquam amet animi blanditiis consequatur debitis dicta distinctio, enim error eum iste libero modi nam
                            </p>
                        </div>
                    </div>
                    <!-- Single Testimonial Item -->
                    ...
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <h3 class="testimonial-title">Jone Doe
                                <small class="post">Programmer</small>
                            </h3>
                            <p class="description">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. A aliquam amet animi blanditiis consequatur debitis dicta distinctio, enim error eum iste libero modi nam
                            </p>
                    ...
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <h3 class="testimonial-title">Jone Doe
                                <small class="post">Web Marketing</small>
                            </h3>
                            <p class="description">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. A aliquam amet animi blanditiis consequatur debitis dicta distinctio, enim error eum iste libero modi nam
                            </p>
...
<section class="" style="background-image: url('{{ asset("public/assets/images/dummy-image-small.jpg") }}'); background-attachment: fixed; background-repeat: no-repeat; background-size: cover;">
    <div class="overlay-7 pt-100 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-title bg-section-title">
                        <h3>Download Here</h3>
            ...
            <div class="col-lg-4">
                <div class="single-pricing-table">
                    ...
                    <div class="pricing-table-content">
                        ...
                        <ul class="list-item">
                            <li><i class="fas fa-check"></i> 100 MB Disk Space</li>
                            <li><i class="fas fa-check"></i> 2 Subdo mains</li>
                ...
                <div class="blog-post-wrapper-div">
                    <div>
                        <div class="blog-post-image-div">
                            <div class="clearfix">
                                <div class="img">
                                    <img src="{{ asset("public/assets/images/blog/dummy-image.jpg") }}" alt="image" class="img-responsive center-block"> </div>
                            </div>
                        </div>
                        <div class="post-detail-container-div">
                            <div class="post-content-div">
                                <h3 class="post-title entry-title">
                                    <a href="blog-details.html">How to Use TasoApp</a>
                                </h3>
                                <ul class="list-unstyled list-inline post-metadata">
                                    <li>
                                        <i class="far fa-calendar"></i> Mon, 01-09-2018&nbsp;&nbsp;| </li>
                                    <li>
                                        <i class="far fa-comment"></i>&nbsp;
                                        <a href="#">Comments(10)</a>
                                    </li>
                                </ul>
                                <p class="post-excerpt">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                    tempor</p>
                ...
                <div class="blog-post-wrapper-div">
                    <div>
                        ...
                        <div class="post-detail-container-div">
                            <div class="post-content-div">
                                <h3 class="post-title entry-title">
                                    <a href="blog-details.html">Responsive app is TasoApp</a>
                                </h3>
                                <ul class="list-unstyled list-inline post-metadata">
                                    <li>
                                        <i class="far fa-calendar"></i> Mon, 30-10-2018&nbsp;&nbsp;| </li>
                                    <li>
                                        <i class="far fa-comment"></i>&nbsp;
                                        <a href="#">Comments(9)</a>
                                    </li>
                ...
                <div class="blog-post-wrapper-div">
                    <div>
                        ...
                        <div class="post-detail-container-div">
                            <div class="post-content-div">
                                <h3 class="post-title entry-title">
                                    <a href="blog-details.html">Why You Need TaspApp</a>
                                </h3>
                                <ul class="list-unstyled list-inline post-metadata">
                                    <li>
                                        <i class="far fa-calendar"></i> Mon, 14-11-2018&nbsp;&nbsp;| </li>
                                    <li>
                                        <i class="far fa-comment"></i>&nbsp;
                                        <a href="#">Comments(5)</a>
                                    </li>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="subscribe-form ">
                    <form action="# "  class="subscribe-mail " >
                        <div class="form-group ">
                            <input type="email" class="form-control email-input " placeholder="Enter your email ">
                            <button class="btn btn-subscribe bg-color-1 " value="Subscribe ">Subscribe</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div id="client-caro" class="clients-carousel  owl-carousel">
                <div class="item">
                    <a href="#"><img src="{{ asset("public/assets/images/logo/dummy-image.png") }}" class="img-responsive" alt=""></a>
                </div>
                <div class="item">
                    <a href="#"><img src="{{ asset("public/assets/images/logo/dummy-image.png") }}" class="img-responsive" alt=""></a>
                </div>
